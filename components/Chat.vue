            ...
            <div class="border-t rounded-b-lg bg-white p-4">
                <div class="flex space-x-2">
                    <input v-model="userInput" @keyup.enter="sendMessage"
                        class="flex-1 border rounded-full px-4 py-2 focus:outline-none focus:border-gray-800 focus:ring-1 focus:ring-gray-800"
                        placeholder="Type your message...">
                    <button @click="sendMessage"
                        class="bg-gray-900 text-white rounded-full px-4 py-2 hover:bg-gray-600 focus:outline-none">
